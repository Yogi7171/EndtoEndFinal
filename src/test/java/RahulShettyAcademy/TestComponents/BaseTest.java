	...
	public WebDriver initializationDriver() throws IOException 
	{
		...
		{	
			...
			options.addArguments("headless");
			 ...
			 driver.manage().window().setSize(new Dimension(1440, 900));// run in fullscreen
			
		}
		else if(browserName.equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\chauh\\Downloads\\geckodriver-v0.32.2-win-aarch64\\geckodriver.exe");
